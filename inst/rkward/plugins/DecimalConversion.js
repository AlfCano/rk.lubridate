...
function preview(){
	var dt = getValue("dt_object"); var func = getValue("dec_func"); var r_command = "lubridate::" + func + "(" + dt + ")"; echo("preview_data <- data.frame(Result=" + r_command + ");\n");
}
...
var dt = getValue("dt_object"); var func = getValue("dec_func"); var r_command = "lubridate::" + func + "(" + dt + ")"; echo("dec_result <- " + r_command + ";\n");
}
...
function printout(is_preview){
	...
	if(!is_preview) {
		new Header(i18n("Decimal Conversion results")).print();	
	}
	...
	if(!is_preview) {
		...
		if(saveResultActive) {
			echo(".GlobalEnv$" + saveResult + " <- dec_result\n");
		}	
	}
